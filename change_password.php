...
<style type="text/css" media="screen">
		...
		.texto {	font:Tahoma, Geneva, sans-serif;
	color:#FFF;
}
td.list {BACKGROUND: #222222; white-space: nowrap; }
</style>
...
<div style="background:url(../images/servidor.png) no-repeat;">
  <div class='memin'></div><div class='memin'></div><br></br><br></br></span>
    ...
    <table border="0" align="center">
      <div style="PADDING-RIGHT: 10px; PADDING-LEFT: 10px; PADDING-BOTTOM: 2px; PADDING-TOP: 2px;&gt;
&lt;td class=listtitle colspan=2 bgcolor="#222222">&nbsp;
        <form method="post" action="changepass_do.php" onsubmit="return chk_form();" >
          <tr>
            <td class="mamon" align="right">Current Password:</td>
            <td class="list"><input name="pass" type="password" class="input_text" style="ime-mode:disabled" maxlength="10" /></td>
          </tr>
          <tr>
            <td class="mamon" align="right">New Password:</td>
            <td class="list"><input name="vpass" type="password" class="input_text" style="ime-mode:disabled" maxlength="10" /></td>
          </tr>
          <tr>
            <td class="mamon" align="right">Repeat New Password:</td>
            <td class="list"><input name="vvpass" type="password" class="input_text" style="ime-mode:disabled" maxlength="10" /></td>
          </tr>
          <tr>
            <td class="texto" align="right" colspan="2"><center>
              <input type='submit' class="form-button" id="btn_01" value="Change" />
              <?php ob_end_flush(); ?>
            </center></td>
          </tr>
        </form>
