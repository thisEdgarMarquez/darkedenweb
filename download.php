...
<div style="background:url(../images/servidor.png) no-repeat;"><div class='memin'></div><div class='memin'></div><br></br><br></br></span>
    ...
    <div id="content-middle" style="background:#000">
      <div class="content-middlqe" style="background:#000" data-href="http://www.facebook.com/deinfierno" data-width="548" data-colorscheme="dark" data-show-faces="true" data-border-color="white" data-stream="true" data-header="true"><div class="content-middlqe"><br></br><br></br><br></br >
              <table width="100%" cellpadding="2" border="0" cellspacing="1">
                <tr class="mamoni">
                <td width="30%" align="center"><a title="Descarga el cliente" href="http://www.mediafire.com/?dgbzdtxadldw0pd">Setup.exe</a></td>
                <td width="25%" align="center">836mb</td>
                <td width="45%" align="center">CLIENT</td>
                </tr>
                <tr class="mamoni">
                <td align="center"><a title="Tipo de fuente" href="http://www.dkinframundo.com/descargar/fixgame.rar">Fixgame.exe</a></td>
                <td class="center"><center>1mb</center></td>
                <td class="center"><center>
                  FONT - FIX
                </center></a></td>
                </tr>
                <tr class="mamoni">
                  <td align="center"><a href="http://www.dkinframundo.com/descargar/DKInframundo_Launcher.rar">Launcher.rar</a></td>
                  <td class="center"><center>584kb</center></td>
                  <td class="center"><center>launcher game</center></td>
                </tr>
          </table>
          <br></br><br></br>
        <div><img src="images/requeriment.png"></div>
                <table width="100%" border="0" cellpadding="3" cellspacing="1">
                <tr>
                <td colspan="3" class="mamono" align="left"><span class="mamoni" id="result_box6" lang="en" xml:lang="en"><center>This program is currently only runs on Windows 32-bit</center></span></td>
                </tr>
                <tr class="bg">
                <th align="center" width="20%"><strong class="mamon">Hadware</strong></th>
                <th align="center" width="30%"><span class="mamon" id="result_box4" lang="en" xml:lang="en">minimum</span></th>
                <th align="center" width="50%"><span class="mamon" id="result_box5" lang="en" xml:lang="en">recommended</span></th>
                </tr>
                <tr>
                <td class="mamono" align="center"><span id="result_box" lang="en" xml:lang="en">Processor</span></td>
                <td class="mamono" align="center">Pentium II - 500 mhz</td>
                <td class="mamono" align="center">Pentium III - 1000 mhz ou superior</td>
                </tr>
                <tr class="mamono">
                <td align="center"><span id="result_box2" lang="en" xml:lang="en">Ram memory</span></td>
                <td align="center">256 MB</td>
                <td align="center">512 MB o superior</td>
                </tr>
                <tr class="mamono">
                <td align="center"><span id="result_box3" lang="en" xml:lang="en">Video Card</span></td>
                <td align="center">32 MB</td>
                <td align="center">128 MB o superior</td>
                </tr>
                </table>
                <br />
                </table>
